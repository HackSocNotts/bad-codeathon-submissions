...
#define reeeee argc
#define reeeeee char
#define reeeeeee argv
#define reeeeeeee f1
#define reeeeeeeee f2
#define reeeeeeeeee limit
#define reeeeeeeeeee i
#define reeeeeeeeeeee temp
#define reeeeeeeeeeeee printf
#define reeeeeeeeeeeeee return
#define reeeeeeeeeeeeeee if
#define reeeeeeeeeeeeeeee while
#define reeeeeeeeeeeeeeeee {
#define reeeeeeeeeeeeeeeeee }
#define reeeeeeeeeeeeeeeeeee strtol
#define reeeeeeeeeeeeeeeeeeee NULL
#define reeeeeeeeeeeeeeeeeeeee 1
#define reeeeeeeeeeeeeeeeeeeeee 0
#define reeeeeeeeeeeeeeeeeeeeeee 2
#define reeeeeeeeeeeeeeeeeeeeeeee 3
#define reeeeeeeeeeeeeeeeeeeeeeeee 10
#define reeeeeeeeeeeeeeeeeeeeeeeeee "0\n"
